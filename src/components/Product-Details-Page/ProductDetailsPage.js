...
const ProductDetailsPage = () => {
  ...
  const renderProducts = () => {
    ...
    if (!productDetailsLoading && productDetails.length == 0)
      return <h1>No product avabile.</h1>;
            ...
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                  {" "}
                  {productDetails.name} | {productDetails.weight}{" "}
                </h1>
                  ...
                  <span class="flex items-center ">
                    <div>
                      <button
                        ...
                        className="font-serif font-medium underline"
                      >
                        {" "}
                        Submit Review
                      </button>
                ...
                <div class="flex">
                  ...
                  >
                    {" "}
                    {isAdded ? "Remove form cart" : "Add to"}{" "}
                  </button>
                </div>
              </div>
            </div>
